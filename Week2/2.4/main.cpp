...
const char lastResort[]   = "LastReso:d=16,o=5,b=100:e,g,f#,g,b,g,f#,g,g,g,f#,g,b,g,f#,g,c,g,f#,g,b,g,f#,g,b,g,f#,g,a,g,f#,g,e,g,f#,g,b,g,f#,g,d,g,f#,g,b,g,f#,g,c,g";
const char iceQueen[]     = "WithinTe:d=16,o=5,b=140:8g#,8e,8p,8f#,8p,8g#,8p,8a,8g#,8f#,8p,8e,8d#,c#,d#,8c#,8p,8g#,8e,8p,8f#,8p,8g#,8p,8f#,8e,8a,8p,8g#,8f#,8g#,8e,8p,8g#,8e,8p,8f#,8p,8g#,8p,8a,8g#,8f#,8p,8e,8d#,8c#,8p,8p,8g#,8e,8p,8f#,8p,8g#,8p,8f#,8e,8a,8p,8g#,8e,8c#";


int main( void ){	
    auto p = my_player();
meldody.open ("meldody.cpp",std::fstream::out);
meldody << "#include \" melody.hpp\" \n" << "void meldody::play( note_player &p){\n";

   if( 1 ){ rtttl_play( p, sos ); }   
   if( 0 ){ rtttl_play( p, let_it_be );  }
   if( 0 ){ rtttl_play( p, muppets );  }
   if( 0 ){ rtttl_play( p, rickroll );  }
   if( 0 ){ rtttl_play( p, lastResort );  }
   if( 0 ){ rtttl_play( p, iceQueen );  }
